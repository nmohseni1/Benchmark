...
def solve(num_agents, edges, timeout,leap_inf,num,idx,rest_inf):
    ...
    for _ in range(num_agents):
        ...
        for c in coalitions:
            if len(c) > 1:
                c1, c2 = split(c, edges, timeout,leap_inf,num,idx)
                ...
                rest_inf[num][idx].append(c_time)
...
def split(c, edges, timeout,leap_inf,num,idx):
    Q = {}
    ...
    solution = utils.solve_with_Leap(Q, len(c),leap_inf,num,idx)
